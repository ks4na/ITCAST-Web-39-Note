...
[跳转链接](H5购物网站宣传/index.html)

## fullpage 全屏插件

全屏滚动效果，原生js也很好实现，主要是用 mousewheel  鼠标滚轮滚动事件， 来判断上滚动还是下滚动，之后设置每次滚动的高度为屏幕的高度即可。但是，虽然效果简单，但是兼容性很差。
...
<script src="js/jquery.min.js"></script>
 <!-- jquery.easings.min.js 缓动动画库，用于 easing 参数 -->
